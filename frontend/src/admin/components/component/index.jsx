...
const ImgConst = ({ src = IMG02, className }) => {
	return <img className={className} alt="User-pic" src={src} />;
};
									...
									<div className="card">
										...
										<div className="card-body">
											<div className="avatar avatar-xxl">
												<ImgConst className="avatar-img rounded-circle" />
											</div>
									...
									<div className="card">
										...
										<div className="card-body">
											<div className="avatar-group">
												<div className="avatar">
													<ImgConst className="avatar-img rounded-circle border border-white" />
												</div>
												<div className="avatar">
													<ImgConst
							...
							<div className="row">
								<div className="col-12 col-md-6 col-lg-4 d-flex">
									<div className="card flex-fill">
										<ImgConst className="card-img-top" src={IMG01} />
										<div className="card-header">
							...
							<div className="card">
								...
								<div className="card-body">
									<p>
										...
										header, modal body (required for padding), and modal footer
