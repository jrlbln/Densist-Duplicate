						...
						<div className="doc-info-right">
							<div className="clini-infos">
								<ul>
									...
									<i className="far fa-money-bill-alt"></i> $300 - $1000 <OverlayTrigger
											overlay={
						...
						<div className="doc-info-right">
							<div className="clini-infos">
								<ul>
									...
									<i className="far fa-money-bill-alt"></i> $50 - $300 <OverlayTrigger
											overlay={
												<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
											}
										>
						...
						<div className="doc-info-right">
							<div className="clini-infos">
								<ul>
									...
									<i className="far fa-money-bill-alt"></i> $100 - $400 <OverlayTrigger
											overlay={
												<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
											}
										>
						...
						<div className="doc-info-right">
							<div className="clini-infos">
								<ul>
									...
									<i className="far fa-money-bill-alt"></i> $150 - $250 <OverlayTrigger
											overlay={
												<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
											}
										>
						...
						<div className="doc-info-right">
							<div className="clini-infos">
								<ul>
									...
									<i className="far fa-money-bill-alt"></i> $100 - $500 <OverlayTrigger
											overlay={
												<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
											}
										>
